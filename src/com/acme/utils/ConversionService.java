...
public class ConversionService {
	...
	public static double[][] allKgToPounds(double... kgValues) {
		double[][] conversions = new double[kgValues.length][2];
		
		for(int i = 0; i < kgValues.length; i++){
			conversions[i][0] = kgValues[i];
			conversions[i][1] = pounds(kgValues[i]);
		}
