...
public class TestGoods {
	...
	public static void main(String[] args) {
		Liquid glue = new Liquid("Acme Glue", 2334, 2, UnitOfMeasureType.LITER, false, 10, 6);
		Liquid paint = new Liquid("Acme Invisible Paint", 2490, 0.65, UnitOfMeasureType.GALLON, true, 0.70, 12);
		Solid anvil = new Solid("Acme Anvil", 1668, 0.3, UnitOfMeasureType.CUBIC_METER, false, 500, 0.5, 0.5);
